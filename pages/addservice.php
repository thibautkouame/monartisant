                     ...
                     <form action="../assets/envoiedonne.php" method="POST">
                        <div class="row">
                           <div class="col-md-6 mb-3">
                              ...
                              <input type="text" class="form-control" id="validationDefault01" required name="libele_service">
                           </div>
                        </div> 
                        <div class="form-group">
                           <button class="btn btn-primary" type="submit" name="btn_serv">Enregistrer</button>
                        </div>
                     </form>
                  </div>
               </div>
