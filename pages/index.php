...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
      ...
      <link rel="stylesheet" href="../assts/css/core/libs.min.css" />
                     ...
                     <div class="d-grid gap col-md-4 col-lg-4">
                        <div class="d-flex align-items-start">
                           <svg class="mt-2 icon-14" xmlns="http://www.w3.org/2000/svg" width="14" viewBox="0 0 24 24" fill="#3a57e8">
                              <g>
                                 <circle cx="12" cy="12" r="8" fill="#ea580c"></circle>
                              </g>
                           </svg>
                           <div class="ms-3">
                              <span class="text-gray">Nombre de Requête</span>
                              <h6 class="mb-0">
                                <?php
         ...
         <div class="col-md-12 col-lg-12">
            <div class="card" data-aos="fade-up" data-aos-delay="500">
               <div class="text-center card-body d-flex justify-content-around">
                  <div>
                     <h2 class="mb-2">0</h2>
                     <p class="mb-0 text-gray">Nombre de visiteurs</p>
                  </div>
                  <hr class="hr-vertial">
                  <div>
                     <h2 class="mb-2">0</h2>
                     <p class="mb-0 text-gray">Nouveaux utilisateurs</p>
                  </div>
               </div>
            </div> 
         </div>
