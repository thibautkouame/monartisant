                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="horizontal-menu" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link " href="../pages/addassurance.php">
                                  <i class="icon">
                    ...
                    <li class="nav-item mb-5">
                        <a href="index.php" class="nav-link" role="button" aria-expanded="false" aria-controls="sidebar-icons">
                            ...
                            <span class="item-name">Deconnexion</span>
                            <i class="right-icon">
                                <svg class="icon-18" xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                                </svg>
        ...
        <nav class="nav navbar navbar-expand-lg navbar-light iq-navbar">
          <div class="container-fluid navbar-inner">
            <a href="../../dashboard/index.html" class="navbar-brand">
                ...
                <!--Logo start-->
                <div class="logo-main">
                    <img src="../logo-monartisan.png" alt="" width="175px">
                </div>
                <!--logo End-->
          ...
          <div class="iq-navbar-header" style="height: 215px;">
              ...
              <div class="iq-header-img">
                  ...
                  <img src="../assets/images/dashboard/top-header4.png" alt="header" class="theme-color-default-imgtheme-color-yellow-img img-fluid w-100 h-100 animated-scaleX">
      ...
      <div class="col-sm-12">
         <div class="card">
            <div class="card-header d-flex justify-content-between">
               <div class="header-title">
                  <h4 class="card-title">Requête Clients</h4>
               </div>
            </div>
            <div class="card-body">
               ...
               <table id="datatable" class="table table-striped">
                     ...
                     <tbody>
                     <?php 
                                    $query = "SELECT * FROM `table_clients` ORDER BY `table_clients`.`id` DESC";
                                    $query_run = mysqli_query($con, $query);

                                    if(mysqli_num_rows($query_run) > 0)
                                    {
                                        foreach($query_run as $table_clients)
                                        {
                                            ?>
                                            <tr>
                                                <td><?= $table_clients['id']; ?></td>
                                                <td><?= $table_clients['assurance']; ?></td> 
                                                <td><?= $table_clients['nomprenoms']; ?></td>
                                                <td><?= $table_clients['email']; ?></td> 
                                                <td><?= $table_clients['contact']; ?></td>
                                                <td><?= $table_clients['lieudusinistre']; ?></td> 
                                                <td><?= $table_clients['datesinistre']; ?></td>
                                                <td><?= $table_clients['natureinter']; ?></td>
                                                <td><?= $table_clients['details']; ?></td>
                                            </tr>
                                            <?php
                                        }
                                    }
                                    ...
                                    {
                                      echo "<h5>Aucune données trouvée</h5>";
                                      // $_SESSION['message'] = "Auccccc";
